...
function Header() {
    ...
    const styleButtonHeader = {
        cursor: 'pointer',
        color: 'white', 
        fontSize: {xl: '1.1rem', xs: '0.6rem'}, 
        marginLeft: {xl: '30px', xs: '15px'}
    };

    const boxHeaderPrincipal = {
        width: scrolled ? '100%' : '80%', 
        height: '60px', 
        transition: 'all 0.4s ease-in-out',
        backgroundColor: '#1F3C3A', 
        top: 0, 
        position: 'fixed', 
        marginTop:  scrolled ? '0px' : '40px', 
        borderRadius: scrolled ? '0px' : '10px',
        display: 'flex', 
    ...
    return (
    <>
        <Box sx={boxHeaderPrincipal}>
            <a href="https://www.linkedin.com/in/dalenconcolares/" target="_blank">
                <svg xmlns="http://www.w3.org/2000/svg" style={{fill: "white", marginRight: "20px"}} viewBox="0 0 100 100" width="25" height="25" id="linkedin">
                    <path d="M87.877 5.608H11.174c-3.673 0-6.65 2.886-6.65 6.448v77.101c0 3.562 2.978 6.45 6.65 6.45h76.703c3.673 0 6.646-2.89 6.646-6.45V12.056c0-3.561-2.973-6.448-6.646-6.448M31.809 80.943H18.211V40.31h13.598v40.633zm-6.798-46.184h-.091c-4.56 0-7.516-3.119-7.516-7.023 0-3.983 3.043-7.017 7.693-7.017 4.651 0 7.512 3.033 7.602 7.017 0 3.905-2.95 7.023-7.688 7.023m55.816 46.184H67.232V59.204c0-5.464-1.969-9.19-6.885-9.19-3.762 0-5.994 2.514-6.974 4.941-.364.868-.453 2.08-.453 3.292v22.696H39.329s.178-36.823 0-40.634h13.593v5.761c1.805-2.768 5.029-6.717 12.249-6.717 8.947 0 15.656 5.804 15.656 18.292v23.298zM52.834 46.199c.023-.038.057-.084.088-.128v.128h-.088z"></path>
                </svg>
            </a>
            <a href="https://github.com/Dalenson" target="_blank">
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 125 125" width="25" height="25" id="github" style={{marginLeft: "50px", marginRight: "20px", fill: "white", verticalAlign: "middle",}}>
                    <g >
                        <path fill-rule="evenodd" d="M64 1.512c-23.493 0-42.545 19.047-42.545 42.545 0 18.797 12.19 34.745 29.095 40.37 2.126.394 2.907-.923 2.907-2.047 0-1.014-.04-4.366-.058-7.92-11.837 2.573-14.334-5.02-14.334-5.02-1.935-4.918-4.724-6.226-4.724-6.226-3.86-2.64.29-2.586.29-2.586 4.273.3 6.523 4.385 6.523 4.385 3.794 6.504 9.953 4.623 12.38 3.536.383-2.75 1.485-4.628 2.702-5.69-9.45-1.075-19.384-4.724-19.384-21.026 0-4.645 1.662-8.44 4.384-11.42-.442-1.072-1.898-5.4.412-11.26 0 0 3.572-1.142 11.7 4.363 3.395-.943 7.035-1.416 10.65-1.432 3.616.017 7.258.49 10.658 1.432 8.12-5.504 11.688-4.362 11.688-4.362 2.316 5.86.86 10.187.418 11.26 2.728 2.978 4.378 6.774 4.378 11.42 0 16.34-9.953 19.938-19.427 20.99 1.526 1.32 2.886 3.91 2.886 7.88 0 5.692-.048 10.273-.048 11.674 0 1.13.766 2.458 2.922 2.04 16.896-5.632 29.07-21.574 29.07-40.365C106.545 20.56 87.497 1.512 64 1.512z" clip-rule="evenodd"></path>
